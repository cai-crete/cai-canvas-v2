...
- [ ] 개발 서버에서 Generate 동작 확인 (500 오류 해소) — `.env.local` 설정 후 검증 예정
- [ ] blank 외 노드에서 EXPAND 버튼 표시 확인 — `.env.local` 설정 후 검증 예정
- [ ] blank 노드에서 EXPAND 버튼 미표시 확인 — `.env.local` 설정 후 검증 예정
